...
resource "site24x7_opsgenie_integration" "opsgenie_integration" {
  ...
  // (Optional) Resource Type associated with this integration. Default value is '0'. Can take values 0|2|3. '0' denotes 'All Monitors', '1' denotes 'Monitor Groups', '2' denotes 'Monitors', '3' denotes 'Tags'
  selection_type = 0
