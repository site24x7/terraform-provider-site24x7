...
// ========================
resource "site24x7_milestone_marker" "build_deployment" {
  // (Required) Monitor ID or Group ID to associate this milestone with.
...
// ========================
// Feature Release Marker
// ========================
resource "site24x7_milestone_marker" "feature_release" {
  // (Required) Monitor ID or Group ID to associate this milestone with.
  ...
  // (Optional) Milestone description.
  message = "Released dark mode feature for all users"
}
