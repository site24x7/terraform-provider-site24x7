...
* `response_variables` (Map of String) A Map of Response variables for Parameter Forwarding.
* `dynamic_header_params` (Map of String) A Map of Response Header/Cookies for Parameter Forwarding.
