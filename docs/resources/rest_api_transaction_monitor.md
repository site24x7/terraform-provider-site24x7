...
resource "site24x7_rest_api_transaction_monitor" "rest_api_transaction_monitor_multiple_steps_example" {
  // (Required) Display name for the monitor
  display_name = "RestAPI Transaction Monitor Multiple steps"
...
* `on_error` (Integer) Stop on Error severity for the step. '0' means Stop and Notify, '1' means Proceed , '2' means Notify and Proceed
