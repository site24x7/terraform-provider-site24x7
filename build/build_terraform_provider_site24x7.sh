...
if [ $OUT -eq 0 ];then
   ...
   if [ ! -d "$HOME/.terraform.d/plugins/registry.terraform.io/site24x7/site24x7/1.0.0/linux_amd64" ]; then
      sudo mkdir -p $HOME/.terraform.d/plugins/registry.terraform.io/site24x7/site24x7/1.0.0/linux_amd64
   fi
